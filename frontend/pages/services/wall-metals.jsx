...
export async function getServerSideProps() {
  try {
    const data = await getSeoData('wall-metals');
    return {
      props: {
    ...
    console.error('Error fetching Wall Metals SEO data:', error);
    return {
      props: {
        seoData: null,
      },
...
export default function WallMetalsPage({ seoData }) {
  return (
    <LayoutShell>
      <SeoHead pageName="wall-metals" initialSeoData={seoData} />
      <div
