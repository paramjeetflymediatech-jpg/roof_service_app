  ...
  return (
    <LayoutShell>
      <div
        ...
        style={{
          backgroundImage: "url('https://images.unsplash.com/photo-1565008576549-57569a49371d?w=1200&h=400&fit=crop')",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            <div className="lg:col-span-3">
              <motion.div className="mb-8 rounded-lg overflow-hidden shadow-lg" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }}>
                <img src="https://images.unsplash.com/photo-1565008576549-57569a49371d?w=800&h=400&fit=crop" alt="Metal Roofing" className="w-full h-[400px] object-cover" />
              </motion.div>
