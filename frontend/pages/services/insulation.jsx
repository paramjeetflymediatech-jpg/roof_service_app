...
export default function InsulationPage() {
  return (
    <LayoutShell>
      <div className="relative h-64 bg-cover bg-center flex items-center justify-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=1200&h=400&fit=crop')", backgroundPosition: 'center' }}>
        <div className="absolute inset-0 bg-black/50"></div>
        <div className="relative z-10 text-center text-white">
          <motion.h1 className="text-4xl md:text-5xl font-bold mb-4" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>Insulation</motion.h1>
          <motion.div className="flex items-center justify-center gap-2 text-sm" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.2 }}>
            <Link href="/" className="hover:text-amber-400 transition-colors">Home</Link><span>›</span><span>Insulation</span>
          </motion.div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            <div className="lg:col-span-3">
              <motion.div className="mb-8 rounded-lg overflow-hidden shadow-lg" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }}>
                <img src="https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=800&h=400&fit=crop" alt="Roof Insulation" className="w-full h-[400px] object-cover" />
              </motion.div>
              <motion.div className="bg-white rounded-lg shadow-md p-8 space-y-6" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }}>
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">
                    Mainstreet Roofing is a leading provider of roof insulation services, dedicated to enhancing the energy efficiency and comfort of homes and businesses. Our team of skilled professionals excels in installing top-quality insulation materials that effectively regulate indoor temperatures and reduce energy consumption. By prioritizing proper insulation techniques, we help our clients save money on utility bills while also minimizing their environmental impact. Insulation serves as a protective barrier against heat loss during the colder months and heat gain in the warmer seasons, ensuring optimal thermal performance year-round.
                  </p>
                  <p className="text-gray-700 leading-relaxed mb-4">
                    At Mainstreet Roofing, we understand the importance of selecting the right type of insulation for each unique property, taking into account factors such as climate conditions and building design. Whether it's fiberglass, cellulose, foam board or spray foam insulation, we have the expertise to recommend the most suitable solution for maximum effectiveness.
                  </p>
                </div>
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">Expert Insulation Services</h2>
                  <p className="text-gray-700 leading-relaxed">
                    We take pride in delivering durable and long-lasting results that exceed industry standards, providing our customers with peace of mind knowing their properties are well-insulated for years to come. Trust Mainstreet Roofing to enhance your building's energy efficiency through expert roof insulation services tailored to meet your specific needs.
                  </p>
                </div>
              </motion.div>
            </div>
